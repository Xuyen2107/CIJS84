      ...
      <div>
         ...
         <div className="row">
            ...
            <div className="right">
               {topTitle !== "top" && <h3>Nhân dân tệ xuống thấp nhất 5 tháng so với USD</h3>}
               <p className="content">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore cumque
                  architecto velit laboriosam ratione tempore nam possimus debitis temporibus
                  dolores, voluptates labore praesentium doloremque eaque reiciendis, quis
                  cupiditate aliquam consequatur.
               </p>
            </div>
         </div>
      </div>
